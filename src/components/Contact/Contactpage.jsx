...
function Contactpage() {
  ...
  <div className=" mx-auto p-5 lg:mt-7">
  <div className="grid grid-cols-1 md:grid-cols-12 ">
    <div className="bg-gray-100 md:col-span-4 p-10 text-gray-950">
      ...
      <p className="mt-4 leading-7 text-gray-990">
  ...
  <span className="text-sm">House 176, press colony anand nagar Bhopal 462022</span>
</div>
<div className="flex items-center mt-5">
  <svg className="h-6 mr-2 text-indigo-600" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xmlnsXlink="http://www.w3.org/1999/xlink">
    <path d="m455.111 0h-398.222c-25.997 0-47.006 21.009-47.006 47.006v417.988c0 25.997 21.009 47.006 47.006 47.006h398.222c25.997 0 47.006-21.009 47.006-47.006v-417.988c0-25.997-21.009-47.006-47.006-47.006zm-398.222 31.335h398.222c6.895 0 12.488 5.593 12.488 12.488v43.029l-205.524 129.451-205.524-129.451v-43.029c0-6.895 5.593-12.488 12.488-12.488zm398.222 449.33h-398.222c-6.895 0-12.488-5.593-12.488-12.488v-265.763l202.072 127.059c3.883 2.441 8.338 3.649 12.808 3.649s8.925-1.208 12.808-3.649l202.074-127.059v265.763c0 6.895-5.593 12.488-12.488 12.488z"/>
  </svg>
  <span className="text-sm">info.hitechjunction@gmail.com</span>
</div>
      ...
      <div className="flex items-center mt-5">
        ...
        <span className="text-sm">+91 6203176139</span>
      </div>
      <div className="flex items-center mt-5">
    ...
    <form className="md:col-span-8 p-10">
      <div className="flex flex-wrap -mx-3 mb-6">
        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Satyam" />
        ...
        <div className="w-full md:w-1/2 px-3">
          ...
          <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Kumar" />
        </div>
      </div>
      <div className="flex flex-wrap -mx-3 mb-6">
