        ...
        <div className="grid grid-cols-1 md:grid-cols-12 ">
          <div className="bg-gray-100 md:col-span-4 p-10 text-gray-950">
            ...
            <p className="mt-4 leading-7 text-gray-990">
              Need assistance or have a query? Reach out to us! Our team is
              ready to assist you with any questions or concerns you may have.
              Whether it's feedback, support, or just a friendly chat, we're
              here for you. Don't hesitate to get in touch!
            </p>
            <div className="flex items-center mt-5">
              ...
              <span className="text-sm">
                House 176, press colony anand nagar Bhopal 462022
              </span>
            </div>
            <div className="flex items-center mt-5">
              <svg
